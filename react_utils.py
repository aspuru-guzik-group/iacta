...
def reaction_job(xtb,
    ...
    def react_job():
        ...
        if verbose:
            print("Forward reaction (%i to %i)" %(mtd_index, len(constraints)))
        ...
        fstructs, fe, fopt, fgrads = successive_optimization(
            ...
            parameters,
            verbose=verbose)          # otherwise its way too verbose
        ...
        if verbose:
            print("Backward reaction (%i to %i)" %(mtd_index, len(constraints)))
